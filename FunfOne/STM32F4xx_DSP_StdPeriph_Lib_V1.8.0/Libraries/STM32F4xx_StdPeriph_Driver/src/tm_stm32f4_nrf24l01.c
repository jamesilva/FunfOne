...
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P0_0	0xF0
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P0_1	0xF0
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P0_2	0xF0
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P0_3	0xF0
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P0_4	0xF0
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P1_0	0xF0
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P1_1	0xF0
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P1_2	0xF0
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P1_3	0xF0
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P1_4	0xF0
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P2		0xF0	
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P3		0xF0	
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P4		0xF0
#define NRF24L01_REG_DEFAULT_VAL_RX_ADDR_P5		0xF0
#define NRF24L01_REG_DEFAULT_VAL_TX_ADDR_0		0xF0
#define NRF24L01_REG_DEFAULT_VAL_TX_ADDR_1		0xF0
#define NRF24L01_REG_DEFAULT_VAL_TX_ADDR_2		0xF0
#define NRF24L01_REG_DEFAULT_VAL_TX_ADDR_3		0xF0
#define NRF24L01_REG_DEFAULT_VAL_TX_ADDR_4		0xF0
...
uint8_t TM_NRF24L01_Init(uint8_t channel, uint8_t payload_size) {
	...
	/* Auto retransmit delay: 1000 (4x250) us and Up to 15 retransmit trials - not true */
...
void TM_NRF24L01_SetRF(TM_NRF24L01_DataRate_t DataRate, TM_NRF24L01_OutputPower_t OutPwr) {
	...
	if (OutPwr == TM_NRF24L01_OutputPower_0dBm) {
		...
		tmp |= 1;	// set LNA - low noise amplifier
